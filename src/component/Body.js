...
function Body() {
  ...
  const [word, setWord] = useState(
    "Exploring the programming languages like -java, JavaScript, and  as well as frameworks such as and ReactJS, node Js, express js. I am also familiar with JavaScript libraries. Proficient in - front-end : Javascript , ReactJs, JQuery . back-end : express, nodeJs, PHP , Python. Database - mongodb, SQL. Version Control Systems - GIT"
  );
      ...
      >
        <motion.div>
          ...
          >
            ...
            >
              <span style={{ fontSize: "5rem", fontWeight: "700" }}>H</span>arshit
              Saini
            </motion.span>{" "}
          </h1>
        ...
        <motion.div style={{ display: "flex", justifyContent: "center"}}>
          ...
          >
            ...
            >
              ...
              {/*<img src="/portfolio_pic.png" style={{ width: context.isMobile ? "150px" : "300px", height: "auto" }} className={!context.isMobile?style.image:style.mobileImage} />*/}
