        ...
        >
          <div>
            ...
            <p className={styles.contactPara}>
              ...
              <a href="https://github.com/HarshitSaini777" target="_blank" rel="noopener noreferrer">
                Harshit Saini <i className="fa-brands fa-github"></i>
              </a>
            </p>
          </div>
          ...
          <div>
            ...
            <p className={styles.contactPara}>
              ...
              <a href="tel:+8392804175" target="_blank" rel="noopener noreferrer">8392804175</a>
            </p>
            <p className={styles.contactPara}>
              <i className="fa-brands fa-instagram"></i> Instagram: 
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer">Harshit Saini</a>
            </p>
            <p className={styles.contactPara}>
              <i className="fa-brands fa-telegram"></i> Telegram: 
              <a href="https://web.telegram.org/a/" target="_blank" rel="noopener noreferrer">Harshit</a>
            </p>
          </div>
        </motion.div>
      </div>
